...
export const actionScenarios: PreviewScenario[] = [
  {
    ...
    actionInput: { kind: "text", text: "Generate a secure password" },
  ...
  },
  {
    ...
    actionInput: { kind: "text", text: "Generate a sortable identifier" },
  ...
  },
  {
    ...
    actionInput: { kind: "text", text: "Draft a neutral placeholder paragraph" },
