...
// color-swatch and gradient-swatch both have stable swatch layouts (~235px and ~225px)
// that fit comfortably within their fixed 260px manifest height — kept as fixed.
