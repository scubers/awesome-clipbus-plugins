...
import { sortCharacters } from "./transforms.ts";
...
export function createSortCharactersAction(): PluginAutoRunActionHandler {
  return {
    ...
    async runAutoAction(
      ...
      return actionResult.text(sortCharacters(content.text), {
        userMessage: "Done",
      });
    },
  };
