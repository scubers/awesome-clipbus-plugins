...
| [clipbus-formatter-plugin](./clipbus-formatter-plugin/README.md) | 格式美化：识别 JSON / XML / SQL 缩进或关键字大写（含一键 JSON→YAML 切换查看与复制），将 CSV/TSV 渲染为表格，并把 URL 查询串解析为键值表——格式化预览一键复制 |
