...
| [clipbus-extractor-plugin](./clipbus-extractor-plugin/README.md) | Extract & parse: pull de-duplicated URLs / Emails / IPv4 from text, break a single URL into scheme / host / path / query, a single IP / CIDR into version / scope / network range, or a lat/lng pair into DMS + map links, plus a regex-tester draft. |
